...
text_encoders = [
    CLIPTextModel.from_pretrained(FILE_PATH, subfolder="text_encoder").to(DEVICE),
    CLIPTextModelWithProjection.from_pretrained(FILE_PATH, subfolder="text_encoder_2").to(DEVICE)
]
